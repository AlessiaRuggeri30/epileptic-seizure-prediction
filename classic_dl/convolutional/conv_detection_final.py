    ...
    for subsampling_factor, stride, look_back, target_steps_ahead in product(*tunables_sequences):
        ...
        for epochs, depth_conv, depth_dense, filters, kernel_size, reg_n,\
            ...
            if saving:
                ...
                model.save(f"{MODEL_PATH}conv_det_model{num}.h5")
                # del model
                # model = load_model(f"{MODEL_PATH}conv_det_model{num}.h5")
            ...
            if saving:
                ...
                EXP_FILENAME = "experiments_conv_det_final"
