...
dump(clf, f"gradient_boosting_model{num}.joblib")
# clf = load(f"gradient_boosting_model{num}.joblib")
# clf = load(f"gradient_boosting_model1.joblib")
...
exp = "exp" + str(num)
file_name = exp + "_gradient_boosting.txt"

with open(file_name, 'w') as file:
    file.write(f"EXPERIMENT {num}: GRADIENT BOOSTING\n\n")
